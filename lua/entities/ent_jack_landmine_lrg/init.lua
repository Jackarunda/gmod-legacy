...
function ENT:Detonate(toucher)
	...
	for key,found in ipairs(ents.FindInSphere(SelfPos,75))do
	...
	for key,playa in ipairs(ents.FindInSphere(SelfPos,100))do
	...
	for key,object in ipairs(ents.FindInSphere(SelfPos,150))do
