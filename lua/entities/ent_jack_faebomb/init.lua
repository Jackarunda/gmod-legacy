...
function ENT:SpawnFunction(ply, tr)
	...
	local ent=ents.Create("ent_jack_faebomb")
	ent:SetPos(SpawnPos)
...
function ENT:Detonate()
	...
	sound.Play("snd_jack_faesplodeclose.wav",SelfPos,110,100)
	sound.Play("snd_jack_faesplodefar.wav",SelfPos,150,100)
	...
	splad:SetScale(1)
	util.Effect("eff_jack_thermobaricsplode",splad,true,true)
