...
SWEP.WepSelectIcon	= surface.GetTextureID("weapons/wep_jack_landmine_WSI")
...
function SWEP:GetViewModelPosition(pos,ang)
	...
	if((self:GetOwner():KeyDown(IN_SPEED))or(self.dt.State==8))then
